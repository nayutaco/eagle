...
extern cstring *ICACHE_FLASH_ATTR cstr_new_sz(size_t sz);
//extern cstring *cstr_new_buf(const void *buf, size_t sz);
extern void ICACHE_FLASH_ATTR cstr_free(cstring *s, bool free_buf);

//extern bool cstr_equal(const cstring *a, const cstring *b);
extern bool ICACHE_FLASH_ATTR cstr_resize(cstring *s, size_t sz);
